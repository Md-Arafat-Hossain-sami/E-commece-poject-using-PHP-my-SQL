...
<?php
$select_query="select * from `productt` order by rand() limit 0,10";
...
<div class='card'>
  ...
  <div class='card-body'>
    ...
    <a href='product_details.php?products_id=$product_id' class='btn btn-secondary'>View More</a>
  </div>
</div>
</div>";
...
?>
 ...
 <!-- <div class="col-md-4 mb-2"> //(mb-2) is for card space in footer
<div class="card">
  <img class="card-img-top" src="./image/photo 1.png" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Denim Casual</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <h4>Price : $58.24</h4>
    <a href="#" class="btn btn-info">Add to Cart <i class="fa-solid fa-cart-plus"></i></a>
